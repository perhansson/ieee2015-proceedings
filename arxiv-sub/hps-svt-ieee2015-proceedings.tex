...
\begin{figure}[]
\centering
\includegraphics[width=3.0in]{halfmodule-L1-3.jpg}
\caption{A half-module for layer 1-3 mounted on the module support.}
\label{fig:half-modules-L1-3}
\end{figure}
\begin{figure}[]
\centering
\includegraphics[width=3.0in]{halfmodule-L4-6-assembly.jpg}
...
\begin{figure}[]
\centering
\includegraphics[width=3.0in]{uchannel-L4-6.jpg}
...
\begin{figure}[]
\centering
\includegraphics[width=3.0in]{vacuum-box.jpg}
...
\begin{figure}[]
\centering
\includegraphics[width=3.0in]{febs.jpg}
